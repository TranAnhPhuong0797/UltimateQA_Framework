...
public class BasePage {
	...
	public void clickToCheckboxButtonByLabel(WebDriver driver, String checkboxLabelName) {
		...
		checkToDefaultCheckboxOrRadio(driver, BasePageUINopcommerce.DYNAMIC_CHECKBOX_BUTTON_BY_LABEL,
				checkboxLabelName);
	}
	...
	public void selectToDropdownByName(WebDriver driver, String dropdownAttributeName, String itemValue) {
		...
		selectItemInDefaultDropdown(driver, BasePageUINopcommerce.DYNAMIC_DROPDOWN_BY_NAME, itemValue,
	...
	public void waitForElementVisible(WebDriver driver, String xpathLocator, String... dynamicValues) {
		...
		explicitwait.until(ExpectedConditions
				.visibilityOfElementLocated(getByLocator(getDynamicXpath(xpathLocator, dynamicValues))));
	}
	...
	public void waitForAllElementsVisible(WebDriver driver, String xpathLocator, String... dynamicValues) {
		WebDriverWait explicitwait = new WebDriverWait(driver, longTimeout);
		explicitwait.until(ExpectedConditions
				.visibilityOfAllElementsLocatedBy(getByLocator(getDynamicXpath(xpathLocator, dynamicValues))));
	}
	...
	public void waitForElementClickable(WebDriver driver, String xpathLocator, String... dynamicValues) {
		WebDriverWait explicitwait = new WebDriverWait(driver, longTimeout);
		explicitwait.until(
				ExpectedConditions.elementToBeClickable(getByLocator(getDynamicXpath(xpathLocator, dynamicValues))));
	}
	...
	public void waitForElementInvisible(WebDriver driver, String xpathLocator, String... dynamicValues) {
		WebDriverWait explicitwait = new WebDriverWait(driver, longTimeout);
		explicitwait.until(ExpectedConditions
				.invisibilityOfElementLocated(getByLocator(getDynamicXpath(xpathLocator, dynamicValues))));
	}
	...
	public void uploadMultipleFiles(WebDriver driver, String xpathLocator, String... fileNames) {
	...
	public void verifyBarNotificationWithHyperLink(WebDriver driver, String message) {
		Assert.assertEquals(
				getElementAttribute(driver, BasePageUINopcommerce.BAR_NOTIFICATION_SUCCESS_HAVE_HYPERLINK, "innerText"),
				message);
	}
